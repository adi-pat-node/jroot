...
import { s, track } from "framer-motion/client";
...
const Blurbg = () => {
  return (
    <div className="fixed top-0 left-0 w-full h-full -z-10 overflow-hidden pointer-events-none flex justify-center items-center filter blur-[100px] opacity-70">
      <motion.div
